...
public class VideoPostMapper {
    ...
    @Autowired
    public VideoPostMapper(ModelMapper modelMapper) {
     ...
     *
     * @param videoPost the VideoPost object to convert
     * @return the converted VideoPostDTO object
     */
    public VideoPostDTO videoPostToDTO(VideoPost videoPost) {
        return modelMapper.map(videoPost, VideoPostDTO.class);
    }
    ...
    public VideoPost dtoToVideoPost(VideoPostDTO videoPostDTO) {
        return modelMapper.map(videoPostDTO, VideoPost.class);
    }
}

//import com.avinash.danumalk.post.VideoPost;
//import com.avinash.danumalk.post.VideoPostDTO;
//import org.springframework.stereotype.Component;
//
//@Component
//public class VideoPostMapper {
