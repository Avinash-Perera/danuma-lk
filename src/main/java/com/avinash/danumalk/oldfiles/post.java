...
//
//
//        ImagePost imagePost = imagePostMapper.mapToImagePost(post, postType);
...
//        ImagePost updatedPost = imagePostMapper.mapToImagePost(post, postType);
//
...
//
//    @Override
//    public ImagePostResponse getById(UUID id) {
//        ImagePost existingPost = imagePostRepository.findById(id).orElseThrow(() -> new IllegalStateException("Post not found!"));
//
//        return null;
//    }
